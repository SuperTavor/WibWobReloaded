...
.method private onCompleteWebDialog(Landroid/os/Bundle;Lcom/facebook/FacebookException;)V
    ...
    invoke-virtual {p0}, Lcom/facebook/internal/FacebookDialogFragment;->getActivity()Landroid/support/v4/app/ag;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v4/app/ag;->getIntent()Landroid/content/Intent;
    ...
    :goto_0
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/app/ag;->setResult(ILandroid/content/Intent;)V

    invoke-virtual {v1}, Landroid/support/v4/app/ag;->finish()V
...
.method private onCompleteWebFallbackDialog(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v2, v1}, Landroid/support/v4/app/ag;->setResult(ILandroid/content/Intent;)V

    invoke-virtual {v0}, Landroid/support/v4/app/ag;->finish()V
