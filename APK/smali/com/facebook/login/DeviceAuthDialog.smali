...
.method private initializeContentView(Z)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/facebook/login/DeviceAuthDialog;->getActivity()Landroid/support/v4/app/ag;
    ...
    invoke-virtual {v2}, Lcom/facebook/internal/FetchedAppSettings;->getSmartLoginBookmarkIconURL()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    sget v0, Lcom/facebook/R$id;->com_facebook_smart_instructions_2:I
    ...
    invoke-direct {p0, v0, v3}, Lcom/facebook/login/DeviceAuthDialog;->appendIconToTextView(Landroid/widget/TextView;Ljava/lang/String;)V

    :cond_0
    invoke-virtual {v2}, Lcom/facebook/internal/FetchedAppSettings;->getSmartLoginMenuIconURL()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_1

    sget v0, Lcom/facebook/R$id;->com_facebook_smart_instructions_1:I
    ...
    invoke-direct {p0, v0, v2}, Lcom/facebook/login/DeviceAuthDialog;->appendIconToTextView(Landroid/widget/TextView;Ljava/lang/String;)V
...
.method private presentConfirmation(Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsPair;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v4, p0, p1, p2, p3}, Lcom/facebook/login/DeviceAuthDialog$7;-><init>(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsPair;Ljava/lang/String;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-super {p0, p1, p2, p3}, Landroid/support/v4/app/ac;->onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
