.class public Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;
...
# static fields
.field public static final nMsgID:I = 0x20bd42a
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->bSubMessageFlag:Z
    ...
    :cond_0
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->senderMemberNo:J
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->receiverMemberNo:J
    ...
    iget v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContentType:I
    ...
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContent:Ljava/lang/String;
...
.method public GetSubMessageFlag()Z
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->bSubMessageFlag:Z
...
.method public Load([BI)I
    ...
    const-string v1, "ReqSendMsg.Load() - Invalid value of offset"
    ...
    const-string v1, "ReqSendMsg.Load() - Invalid message identifier"
    ...
    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->senderMemberNo:J

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadLong(Ljava/nio/ByteBuffer;)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->receiverMemberNo:J

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v1

    iput v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContentType:I
    ...
    iput-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContent:Ljava/lang/String;
...
.method public Load(Ljava/io/InputStream;)V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContent:Ljava/lang/String;
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->GetMaxLength()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->senderMemberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->receiverMemberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContentType:I

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveInt(Ljava/nio/ByteBuffer;I)V

    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->messageContent:Ljava/lang/String;
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendMsg;->bSubMessageFlag:Z
