.class public Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;
...
# static fields
.field public static final nMsgID:I = 0x12e53ca


# instance fields
.field private bSubMessageFlag:Z

.field public certificationNo:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->bSubMessageFlag:Z
    ...
    :cond_0
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->memberNo:J
    ...
    iget v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->certificationNo:I
...
.method public GetSubMessageFlag()Z
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->bSubMessageFlag:Z
...
.method public Load([BI)I
    ...
    const-string v1, "ReqSetPhoneNo.Load() - Invalid value of offset"
    ...
    const-string v1, "ReqSetPhoneNo.Load() - Invalid message identifier"
    ...
    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->memberNo:J

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v1

    iput v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->certificationNo:I
...
.method public Load(Ljava/io/InputStream;)V
    ...
    iput v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->certificationNo:I
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->GetMaxLength()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->memberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->certificationNo:I
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSetPhoneNo;->bSubMessageFlag:Z
