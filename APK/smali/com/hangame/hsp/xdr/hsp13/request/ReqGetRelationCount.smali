.class public Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;
...
# static fields
.field public static final nMsgID:I = 0x28aeeba
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->bSubMessageFlag:Z
    ...
    :cond_0
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->memberNo:J
    ...
    iget-byte v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->relationType:B
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "ReqGetRelationCount"
...
.method public GetSubMessageFlag()Z
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->bSubMessageFlag:Z
...
.method public Load([BI)I
    ...
    const-string v1, "ReqGetRelationCount.Load() - Invalid value of offset"
    ...
    const-string v1, "ReqGetRelationCount.Load() - Invalid message identifier"
    ...
    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->memberNo:J

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadByte(Ljava/nio/ByteBuffer;)B

    move-result v1

    iput-byte v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->relationType:B
...
.method public Load(Ljava/io/InputStream;)V
    ...
    iput-byte v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->relationType:B
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->GetMaxLength()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->memberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget-byte v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->relationType:B
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetRelationCount;->bSubMessageFlag:Z
