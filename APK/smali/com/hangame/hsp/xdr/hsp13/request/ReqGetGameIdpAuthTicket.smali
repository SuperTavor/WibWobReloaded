.class public Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;
...
# static fields
.field public static final nMsgID:I = 0x1924cba
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->bSubMessageFlag:Z
    ...
    :cond_0
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iget v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->gameNo:I
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->memberNo:J
    ...
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->idpCode:Ljava/lang/String;
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "ReqGetGameIdpAuthTicket"
...
.method public GetSubMessageFlag()Z
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->bSubMessageFlag:Z
...
.method public Load([BI)I
    ...
    const-string v1, "ReqGetGameIdpAuthTicket.Load() - Invalid value of offset"
    ...
    const-string v1, "ReqGetGameIdpAuthTicket.Load() - Invalid message identifier"
    ...
    iput v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->gameNo:I

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadLong(Ljava/nio/ByteBuffer;)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->memberNo:J
    ...
    iput-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->idpCode:Ljava/lang/String;
...
.method public Load(Ljava/io/InputStream;)V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->idpCode:Ljava/lang/String;
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->GetMaxLength()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->gameNo:I

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveInt(Ljava/nio/ByteBuffer;I)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->memberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->idpCode:Ljava/lang/String;
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetGameIdpAuthTicket;->bSubMessageFlag:Z
