.class public Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;
...
# static fields
.field public static final nMsgID:I = 0x8efb1da
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->param:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->bSubMessageFlag:Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->memberNo:J
    ...
    iget v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->gameNo:I
    ...
    iget v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->osNo:I
    ...
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->message:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->param:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->param:Ljava/util/HashMap;
    ...
    const-string v1, "ReqSendPushMsg.GetLength() - Invalid key type. Key must be String."
    ...
    const-string v1, "ReqSendPushMsg.GetLength() - Invalid value type. Value must be String."
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "ReqSendPushMsg"
...
.method public Load([BI)I
    ...
    const-string v1, "ReqSendPushMsg.Load() - Invalid value of offset"
    ...
    const-string v1, "ReqSendPushMsg.Load() - Invalid message identifier"
    ...
    :cond_2
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->memberNo:J

    invoke-static {v1}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v0

    iput v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->gameNo:I

    invoke-static {v1}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v0

    iput v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->osNo:I
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->message:Ljava/lang/String;

    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->param:Ljava/util/HashMap;
    ...
    iget-object v5, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->param:Ljava/util/HashMap;
...
.method public Save(Ljava/io/OutputStream;)V
    ...
    iget-wide v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->memberNo:J

    invoke-static {v3, v0, v1}, LXDR/Translator/Serializer;->SaveLong(Ljava/io/DataOutputStream;J)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->gameNo:I

    invoke-static {v3, v0}, LXDR/Translator/Serializer;->SaveInt(Ljava/io/DataOutputStream;I)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->osNo:I

    invoke-static {v3, v0}, LXDR/Translator/Serializer;->SaveInt(Ljava/io/DataOutputStream;I)V

    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->message:Ljava/lang/String;
    ...
    const-string v1, "ReqSendPushMsg.Save() - Invalid key type. Key must be String."
    ...
    const-string v1, "ReqSendPushMsg.Save() - Invalid value type. Value must be String."
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->GetMaxLength()I
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqSendPushMsg;->bSubMessageFlag:Z
