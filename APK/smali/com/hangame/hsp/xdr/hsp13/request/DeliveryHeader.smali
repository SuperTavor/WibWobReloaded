.class public Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;
...
# static fields
.field public static final nMsgID:I = 0x3fdd43a
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->bSubMessageFlag:Z
    ...
    :cond_0
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->deliveryTxId:J
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->memberNo:J
    ...
    iget v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->gameNo:I
    ...
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->requester:Ljava/lang/String;
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "DeliveryHeader"
...
.method public GetSubMessageFlag()Z
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->bSubMessageFlag:Z
...
.method public Load([BI)I
    ...
    const-string v1, "DeliveryHeader.Load() - Invalid value of offset"
    ...
    const-string v1, "DeliveryHeader.Load() - Invalid message identifier"
    ...
    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->deliveryTxId:J

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadLong(Ljava/nio/ByteBuffer;)J

    move-result-wide v2

    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->memberNo:J

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v1

    iput v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->gameNo:I
    ...
    iput-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->requester:Ljava/lang/String;
...
.method public Load(Ljava/io/InputStream;)V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->requester:Ljava/lang/String;
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->GetMaxLength()I
    ...
    :cond_0
    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->deliveryTxId:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->memberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->gameNo:I

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveInt(Ljava/nio/ByteBuffer;I)V

    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->requester:Ljava/lang/String;
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/DeliveryHeader;->bSubMessageFlag:Z
