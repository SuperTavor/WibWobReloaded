.class public Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;
...
# static fields
.field public static final nMsgID:I = 0x8c6045a
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->bSubMessageFlag:Z
    ...
    :cond_0
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;
    ...
    iget-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->memberNo:J
    ...
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->idpCode:Ljava/lang/String;
    ...
    iget v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->offset:I
    ...
    iget v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->count:I
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "ReqGetIdpIdOnWhiteList"
...
.method public GetSubMessageFlag()Z
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->bSubMessageFlag:Z
...
.method public Load([BI)I
    ...
    const-string v1, "ReqGetIdpIdOnWhiteList.Load() - Invalid value of offset"
    ...
    const-string v1, "ReqGetIdpIdOnWhiteList.Load() - Invalid message identifier"
    ...
    iput-wide v2, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->memberNo:J
    ...
    iput-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->idpCode:Ljava/lang/String;

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v1

    iput v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->offset:I

    invoke-static {v0}, LXDR/Translator/Serializer;->LoadInt(Ljava/nio/ByteBuffer;)I

    move-result v1

    iput v1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->count:I
...
.method public Load(Ljava/io/InputStream;)V
    ...
    iput v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->count:I
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->GetMaxLength()I
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/request/ReqHeader;

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-wide v4, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->memberNo:J

    invoke-static {v2, v4, v5}, LXDR/Translator/Serializer;->SaveLong(Ljava/nio/ByteBuffer;J)V

    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->idpCode:Ljava/lang/String;

    const-string v3, ""

    invoke-static {v2, v0, v3}, LXDR/Translator/Serializer;->SaveString(Ljava/nio/ByteBuffer;Ljava/lang/String;Ljava/lang/String;)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->offset:I

    invoke-static {v2, v0}, LXDR/Translator/Serializer;->SaveInt(Ljava/nio/ByteBuffer;I)V

    iget v0, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->count:I
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/request/ReqGetIdpIdOnWhiteList;->bSubMessageFlag:Z
