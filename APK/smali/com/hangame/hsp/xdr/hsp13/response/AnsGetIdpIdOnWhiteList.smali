.class public Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;
...
# static fields
.field public static final nMsgID:I = 0xab12eba
...
.field public profileList:Ljava/util/Vector;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;

    new-instance v0, Ljava/util/Vector;

    invoke-direct {v0}, Ljava/util/Vector;-><init>()V

    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->profileList:Ljava/util/Vector;

    new-instance v0, Ljava/util/Vector;

    invoke-direct {v0}, Ljava/util/Vector;-><init>()V

    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->idpIdList:Ljava/util/Vector;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->bSubMessageFlag:Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;
    ...
    :goto_1
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->profileList:Ljava/util/Vector;
    ...
    const-string v1, "AnsGetIdpIdOnWhiteList.GetLength() - Invalid element type. Element type must be XDR.IMessage."
    ...
    :goto_2
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->idpIdList:Ljava/util/Vector;
    ...
    const-string v1, "AnsGetIdpIdOnWhiteList.GetLength() - Invalid element type. Element type must be String."
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "AnsGetIdpIdOnWhiteList"
...
.method public Load([BI)I
    ...
    const-string v1, "AnsGetIdpIdOnWhiteList.Load() - Invalid value of offset"
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->bSubMessageFlag:Z
    ...
    const-string v1, "AnsGetIdpIdOnWhiteList.Load() - Invalid message identifier"
    ...
    :cond_2
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;

    invoke-static {v2, v1}, LXDR/Translator/Serializer;->LoadMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->profileList:Ljava/util/Vector;
    ...
    new-instance v4, Lcom/hangame/hsp/xdr/hsp13/response/Profile;

    invoke-direct {v4}, Lcom/hangame/hsp/xdr/hsp13/response/Profile;-><init>()V

    invoke-static {v2, v4}, LXDR/Translator/Serializer;->LoadMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-object v5, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->profileList:Ljava/util/Vector;
    ...
    :cond_3
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->idpIdList:Ljava/util/Vector;
    ...
    iget-object v4, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->idpIdList:Ljava/util/Vector;
...
.method public Save(Ljava/io/OutputStream;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->GetMaxLength()I
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetIdpIdOnWhiteList;->bSubMessageFlag:Z
