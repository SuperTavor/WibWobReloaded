.class public Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;
...
# static fields
.field public static final nMsgID:I = 0xc8efc6a


# instance fields
.field public achieveItemList:Ljava/util/Vector;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;

    new-instance v0, Ljava/util/Vector;

    invoke-direct {v0}, Ljava/util/Vector;-><init>()V

    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->achieveItemList:Ljava/util/Vector;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->bSubMessageFlag:Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;
    ...
    :goto_1
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->achieveItemList:Ljava/util/Vector;
    ...
    const-string v1, "AnsGetAchieveItemList.GetLength() - Invalid element type. Element type must be XDR.IMessage."
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "AnsGetAchieveItemList"
...
.method public Load([BI)I
    ...
    const-string v1, "AnsGetAchieveItemList.Load() - Invalid value of offset"
    ...
    const-string v1, "AnsGetAchieveItemList.Load() - Invalid message identifier"
    ...
    :cond_2
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;
    ...
    new-instance v3, Lcom/hangame/hsp/xdr/hsp13/response/AchieveItem;

    invoke-direct {v3}, Lcom/hangame/hsp/xdr/hsp13/response/AchieveItem;-><init>()V

    invoke-static {v1, v3}, LXDR/Translator/Serializer;->LoadMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-object v4, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->achieveItemList:Ljava/util/Vector;
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->GetMaxLength()I
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetAchieveItemList;->bSubMessageFlag:Z
