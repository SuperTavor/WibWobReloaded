.class public Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;
...
# static fields
.field public static final nMsgID:I = 0xff9c7ca
...
.field public oauthIdMap:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;

    new-instance v0, Ljava/util/Vector;

    invoke-direct {v0}, Ljava/util/Vector;-><init>()V

    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->memberNoList:Ljava/util/Vector;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->oauthIdMap:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->bSubMessageFlag:Z
...
.method public GetLength()I
    ...
    iget-boolean v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->bSubMessageFlag:Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;
    ...
    :goto_1
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->memberNoList:Ljava/util/Vector;
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.GetLength() - Invalid element type. Element type must be Long."
    ...
    iget-object v2, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->oauthIdMap:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->oauthIdMap:Ljava/util/HashMap;
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.GetLength() - Invalid key type. Key must be Long."
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.GetLength() - Invalid value type. Value must be String."
...
.method public GetName()Ljava/lang/String;
    ...
    const-string v0, "AnsGetOAuthIdListByMemberNoList"
...
.method public Load([BI)I
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.Load() - Invalid value of offset"
    ...
    iget-boolean v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->bSubMessageFlag:Z
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.Load() - Invalid message identifier"
    ...
    :cond_2
    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;

    invoke-static {v2, v1}, LXDR/Translator/Serializer;->LoadMessage(Ljava/nio/ByteBuffer;LXDR/IMessage;)V

    iget-object v1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->memberNoList:Ljava/util/Vector;
    ...
    iget-object v5, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->memberNoList:Ljava/util/Vector;
    ...
    iget-object v5, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->oauthIdMap:Ljava/util/HashMap;
...
.method public Save(Ljava/io/OutputStream;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->header:Lcom/hangame/hsp/xdr/hsp13/response/AnsHeader;
    ...
    iget-object v0, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->oauthIdMap:Ljava/util/HashMap;
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.Save() - Invalid key type. Key must be Long."
    ...
    const-string v1, "AnsGetOAuthIdListByMemberNoList.Save() - Invalid value type. Value must be String."
...
.method public Save()[B
    ...
    invoke-virtual {p0}, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->GetMaxLength()I
...
.method public SetSubMessageFlag(Z)V
    ...
    iput-boolean p1, p0, Lcom/hangame/hsp/xdr/hsp13/response/AnsGetOAuthIdListByMemberNoList;->bSubMessageFlag:Z
