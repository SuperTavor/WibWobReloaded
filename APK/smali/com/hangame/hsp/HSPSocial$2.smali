.class final Lcom/hangame/hsp/HSPSocial$2;
...
# instance fields
.field final synthetic val$callback:Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;

.field final synthetic val$memberNos:Ljava/util/List;


# direct methods
.method constructor <init>(Ljava/util/List;Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;)V
    .locals 0

    iput-object p1, p0, Lcom/hangame/hsp/HSPSocial$2;->val$memberNos:Ljava/util/List;

    iput-object p2, p0, Lcom/hangame/hsp/HSPSocial$2;->val$callback:Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;
...
.method public onReceive(Ljava/lang/Object;Lcom/hangame/hsp/HSPResult;[B)V
    ...
    sget-object v9, Lcom/hangame/hsp/HSPDetailedProfile$HSPRelationType;->HSP_RELATIONTYPE_FOLLOW:Lcom/hangame/hsp/HSPDetailedProfile$HSPRelationType;
    ...
    iget-object v0, p0, Lcom/hangame/hsp/HSPSocial$2;->val$memberNos:Ljava/util/List;
    ...
    :cond_3
    iget-object v0, p0, Lcom/hangame/hsp/HSPSocial$2;->val$callback:Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;

    if-eqz v0, :cond_4

    iget-object v0, p0, Lcom/hangame/hsp/HSPSocial$2;->val$callback:Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;

    invoke-interface {v0, v6, p2}, Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;->onMembersFollow(Ljava/util/List;Lcom/hangame/hsp/HSPResult;)V

    :cond_4
    invoke-static {}, Lcom/hangame/hsp/HSPSocial;->access$000()Ljava/util/Set;
    ...
    check-cast v0, Lcom/hangame/hsp/HSPSocial$HSPAddFollowingListener;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-interface {v0, v6}, Lcom/hangame/hsp/HSPSocial$HSPAddFollowingListener;->onFollowingAdd(Ljava/util/List;)V
    :try_end_1
    ...
    invoke-interface {v0, v1, v2}, Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;->onMembersFollow(Ljava/util/List;Lcom/hangame/hsp/HSPResult;)V
    ...
    invoke-interface {v0, v1, p2}, Lcom/hangame/hsp/HSPSocial$HSPFollowMembersCB;->onMembersFollow(Ljava/util/List;Lcom/hangame/hsp/HSPResult;)V
