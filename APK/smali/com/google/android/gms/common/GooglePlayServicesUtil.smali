...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_5
    new-instance v4, Landroid/support/v4/app/bt;

    invoke-direct {v4, p1}, Landroid/support/v4/app/bt;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/bt;->a(I)Landroid/support/v4/app/bt;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroid/support/v4/app/bt;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/bt;
...
.method public static zza(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    :try_start_0
    instance-of v0, p0, Landroid/support/v4/app/ag;
    :try_end_0
    ...
    check-cast p0, Landroid/support/v4/app/ag;
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/an;Ljava/lang/String;)V
