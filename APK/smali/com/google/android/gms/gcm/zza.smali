...
.method private zzw(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    :cond_6
    new-instance v5, Landroid/support/v4/app/bt;

    iget-object v6, p0, Lcom/google/android/gms/gcm/zza;->mContext:Landroid/content/Context;

    invoke-direct {v5, v6}, Landroid/support/v4/app/bt;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5, v3}, Landroid/support/v4/app/bt;->a(I)Landroid/support/v4/app/bt;

    move-result-object v3

    invoke-virtual {v3, v8}, Landroid/support/v4/app/bt;->a(Z)Landroid/support/v4/app/bt;

    move-result-object v3

    invoke-virtual {v3, v0}, Landroid/support/v4/app/bt;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/bt;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/app/bt;->a(Landroid/net/Uri;)Landroid/support/v4/app/bt;
