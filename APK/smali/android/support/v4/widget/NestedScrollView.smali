...
# interfaces
.implements Landroid/support/v4/h/bc;
.implements Landroid/support/v4/h/be;
...
.field private final x:Landroid/support/v4/h/bf;

.field private final y:Landroid/support/v4/h/bd;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    new-instance v0, Landroid/support/v4/h/bf;

    invoke-direct {v0, p0}, Landroid/support/v4/h/bf;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/h/bf;

    new-instance v0, Landroid/support/v4/h/bd;

    invoke-direct {v0, p0}, Landroid/support/v4/h/bd;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/h/bd;
    ...
    invoke-static {p0, v0}, Landroid/support/v4/h/bm;->a(Landroid/view/View;Landroid/support/v4/h/a;)V
...
.method private a(Landroid/view/MotionEvent;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/h/at;->b(Landroid/view/MotionEvent;I)I
    ...
    :goto_0
    invoke-static {p1, v0}, Landroid/support/v4/h/at;->d(Landroid/view/MotionEvent;I)F
...
.method private g()V
    ...
    invoke-static {p0}, Landroid/support/v4/h/bm;->a(Landroid/view/View;)I
...
.method public final a(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/bm;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ak;->g()V
...
.method public computeScroll()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/ak;->f()Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/ak;->e()F
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/h/bd;

    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/h/bd;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/h/bd;->a(FF)Z
...
.method public dispatchNestedPreScroll(II[I[I)Z
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v4/h/bd;->a(II[I[I)Z
...
.method public dispatchNestedScroll(IIII[I)Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/h/bd;->a(IIII[I)Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/h/bf;

    invoke-virtual {v0}, Landroid/support/v4/h/bf;->a()I
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/bd;->b()Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/bd;->a()Z
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/h/at;->c(Landroid/view/MotionEvent;)I
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/at;->e(Landroid/view/MotionEvent;I)F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/at;->a(Landroid/view/MotionEvent;I)I
    ...
    :cond_2
    invoke-static {p1, v2}, Landroid/support/v4/h/at;->d(Landroid/view/MotionEvent;I)F
    ...
    invoke-static {p1, v3}, Landroid/support/v4/h/at;->b(Landroid/view/MotionEvent;I)I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/h/bf;->a(Landroid/view/View;Landroid/view/View;I)V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/h/bf;->a(Landroid/view/View;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/h/at;->a(Landroid/view/MotionEvent;)I
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/ak;->g()V
    ...
    invoke-static {v0, v2}, Landroid/support/v4/h/at;->b(Landroid/view/MotionEvent;I)I
    ...
    invoke-static {v0, v2}, Landroid/support/v4/h/at;->a(Landroid/view/MotionEvent;I)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/at;->d(Landroid/view/MotionEvent;I)F
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/bm;->a(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/at;->c(Landroid/view/MotionEvent;I)F
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/bm;->b(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/h/bh;->a(Landroid/view/VelocityTracker;I)F
    ...
    :pswitch_5
    invoke-static/range {p1 .. p1}, Landroid/support/v4/h/at;->b(Landroid/view/MotionEvent;)I

    move-result v2

    move-object/from16 v0, p1

    invoke-static {v0, v2}, Landroid/support/v4/h/at;->d(Landroid/view/MotionEvent;I)F
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/h/bd;->a(Z)V
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/h/bd;->a(I)Z
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/bd;->c()V
