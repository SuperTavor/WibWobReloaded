...
.field private final M:Landroid/support/v7/widget/ai;
...
.field private final t:Landroid/support/v7/widget/ch;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/ch;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/db;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-static {v0, p2, v1, p3, v7}, Landroid/support/v7/widget/cz;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/cz;

    move-result-object v0

    sget v1, Landroid/support/v7/b/k;->Toolbar_titleTextAppearance:I

    invoke-virtual {v0, v1, v7}, Landroid/support/v7/widget/cz;->g(II)I
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/cz;->c(II)I
    ...
    invoke-virtual {v0, v1, v7}, Landroid/support/v7/widget/cz;->d(II)I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/cz;->d(II)I
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/cz;->e(II)I
    ...
    invoke-virtual {v0, v1, v8}, Landroid/support/v7/widget/cz;->d(II)I

    move-result v1

    sget v2, Landroid/support/v7/b/k;->Toolbar_contentInsetEnd:I

    invoke-virtual {v0, v2, v8}, Landroid/support/v7/widget/cz;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/b/k;->Toolbar_contentInsetLeft:I

    invoke-virtual {v0, v3, v7}, Landroid/support/v7/widget/cz;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/b/k;->Toolbar_contentInsetRight:I

    invoke-virtual {v0, v4, v7}, Landroid/support/v7/widget/cz;->e(II)I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/ch;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/ch;->b(II)V
    ...
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/ch;

    invoke-virtual {v3, v1, v2}, Landroid/support/v7/widget/ch;->a(II)V

    :cond_5
    sget v1, Landroid/support/v7/b/k;->Toolbar_collapseIcon:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cz;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cz;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cz;->f(I)Z
    ...
    invoke-virtual {v0, v1, v6}, Landroid/support/v7/widget/cz;->b(II)I
    ...
    invoke-static {}, Landroid/support/v7/widget/ai;->a()Landroid/support/v7/widget/ai;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->M:Landroid/support/v7/widget/ai;
...
.method private a(Landroid/view/View;I)I
    ...
    :goto_0
    iget v4, v0, Landroid/support/v7/widget/de;->a:I
    ...
    iget v7, v0, Landroid/support/v7/widget/de;->topMargin:I

    if-ge v1, v7, :cond_1

    iget v0, v0, Landroid/support/v7/widget/de;->topMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/de;->bottomMargin:I
    ...
    iget v5, v0, Landroid/support/v7/widget/de;->bottomMargin:I
...
.method private a(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/de;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/de;->rightMargin:I
...
.method private a(Ljava/util/List;[I)I
    ...
    check-cast v1, Landroid/support/v7/widget/de;

    iget v8, v1, Landroid/support/v7/widget/de;->leftMargin:I

    sub-int v6, v8, v6

    iget v1, v1, Landroid/support/v7/widget/de;->rightMargin:I
...
.method static synthetic a(Landroid/support/v7/widget/Toolbar;)Landroid/support/v7/widget/df;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/df;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->d()Landroid/support/v7/widget/de;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/de;
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/bm;->d(Landroid/view/View;)I
    ...
    invoke-static {p2, v3}, Landroid/support/v4/h/q;->a(II)I
    ...
    iget v4, v0, Landroid/support/v7/widget/de;->b:I
    ...
    iget v5, v0, Landroid/support/v7/widget/de;->b:I
...
.method private b(I)I
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/q;->a(II)I
...
.method private b(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v4/h/ag;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v1

    invoke-static {v0}, Landroid/support/v4/h/ag;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private b(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/de;->rightMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/de;->leftMargin:I
...
.method private h()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/dd;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v7/widget/dd;-><init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/da;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/dd;
...
.method private k()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/dc;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/de;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/widget/de;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/de;
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/de;-><init>(Landroid/support/v7/widget/de;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/de;-><init>(Landroid/support/v7/a/b;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/de;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/de;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/ch;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/ch;->a(II)V
...
.method public c()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/dd;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/view/menu/j;
...
.method protected d()Landroid/support/v7/widget/de;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v7/widget/de;-><init>(II)V
...
.method e()V
    ...
    iget v0, v0, Landroid/support/v7/widget/de;->b:I
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/de;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/de;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ch;->d()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ch;->a()I
...
.method public getContentInsetRight()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ch;->b()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ch;->c()I
...
.method public getWrapper()Landroid/support/v7/widget/bj;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/widget/dh;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->G:Landroid/support/v7/widget/dh;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/h/at;->a(Landroid/view/MotionEvent;)I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/bm;->d(Landroid/view/View;)I
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/bm;->h(Landroid/view/View;)I
    ...
    check-cast v3, Landroid/support/v7/widget/de;

    iget v9, v3, Landroid/support/v7/widget/de;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/de;->bottomMargin:I
    ...
    check-cast v4, Landroid/support/v7/widget/de;
    ...
    iget v0, v3, Landroid/support/v7/widget/de;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/de;->topMargin:I
    ...
    iget v5, v3, Landroid/support/v7/widget/de;->topMargin:I
    ...
    iget v4, v4, Landroid/support/v7/widget/de;->bottomMargin:I
    ...
    iget v10, v3, Landroid/support/v7/widget/de;->topMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/dk;->a(Landroid/view/View;)Z
    ...
    invoke-static {v1}, Landroid/support/v4/h/bm;->f(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/widget/dk;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/h/bm;->f(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/dk;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/dk;->a(II)I
    ...
    invoke-static {v4}, Landroid/support/v4/h/bm;->f(Landroid/view/View;)I

    move-result v4

    invoke-static {v11, v4}, Landroid/support/v7/widget/dk;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/h/bm;->f(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/widget/dk;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/h/bm;->a(III)I
    ...
    invoke-static {v0, p2, v2}, Landroid/support/v4/h/bm;->a(III)I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-static {v0}, Landroid/support/v4/h/al;->a(Landroid/view/MenuItem;)Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/ch;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ch;->a(Z)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/dd;->b:Landroid/support/v7/view/menu/j;
...
.method public setLogo(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->M:Landroid/support/v7/widget/ai;

    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1, p1}, Landroid/support/v7/widget/ai;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/df;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->E:Landroid/support/v7/widget/df;
