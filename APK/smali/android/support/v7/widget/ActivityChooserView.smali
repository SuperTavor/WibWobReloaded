...
# instance fields
.field a:Landroid/support/v4/h/n;

.field private final b:Landroid/support/v7/widget/ae;

.field private final c:Landroid/support/v7/widget/af;
...
# direct methods
.method static synthetic a(Landroid/support/v7/widget/ActivityChooserView;)Landroid/support/v7/widget/ae;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ae;
...
.method private a(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ae;->d()Landroid/support/v7/widget/x;
    ...
    :goto_0
    iget-object v3, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ae;
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/ActivityChooserView;->b:Landroid/support/v7/widget/ae;

    invoke-virtual {v2, v1, v0}, Landroid/support/v7/widget/ae;->a(ZZ)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v4/h/n;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v4/h/n;

    invoke-virtual {v0, v1}, Landroid/support/v4/h/n;->a(Z)V
...
.method private getListPopupWindow()Landroid/support/v7/widget/bp;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->c:Landroid/support/v7/widget/af;
...
.method public setActivityChooserModel(Landroid/support/v7/widget/x;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/x;)V
...
.method public setProvider(Landroid/support/v4/h/n;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v4/h/n;
