...
.method public run()V
    ...
    invoke-static {v1}, Landroid/support/v4/h/bm;->i(Landroid/view/View;)Landroid/support/v4/h/cw;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/h/cw;->a(F)Landroid/support/v4/h/cw;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/support/v7/widget/ActionBarOverlayLayout;

    invoke-static {v2}, Landroid/support/v7/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/h/dl;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/h/cw;->a(Landroid/support/v4/h/dl;)Landroid/support/v4/h/cw;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/h/cw;)Landroid/support/v4/h/cw;
