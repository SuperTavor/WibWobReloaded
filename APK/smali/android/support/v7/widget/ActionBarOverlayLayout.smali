...
.field private final B:Landroid/support/v4/h/bf;
...
.field private x:Landroid/support/v4/h/cw;

.field private final y:Landroid/support/v4/h/dl;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/h/dl;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/h/bf;

    return-void
.end method

.method static synthetic a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/h/cw;)Landroid/support/v4/h/cw;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/cw;

    return-object p1
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/widget/bj;
    .locals 3
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/Toolbar;->getWrapper()Landroid/support/v7/widget/bj;
...
.method static synthetic b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/h/dl;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/h/dl;
...
.method private c()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/cw;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/h/cw;

    invoke-virtual {v0}, Landroid/support/v4/h/cw;->a()V
...
.method b()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/widget/bj;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/bj;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/bm;->g(Landroid/view/View;)F
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/h/bm;->j(Landroid/view/View;)I
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/widget/dk;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public getActionBarHideOffset()I
    ...
    invoke-static {v0}, Landroid/support/v4/h/bm;->g(Landroid/view/View;)F
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->B:Landroid/support/v4/h/bf;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->f:Landroid/support/v7/widget/bj;

    invoke-interface {v0}, Landroid/support/v7/widget/bj;->a()Ljava/lang/CharSequence;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/bm;->k(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v9, v2}, Landroid/support/v7/widget/dk;->a(II)I
...
.method public setActionBarHideOffset(I)V
    ...
    invoke-static {v1, v0}, Landroid/support/v4/h/bm;->a(Landroid/view/View;F)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bj;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bj;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bj;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bj;->a(Landroid/view/Window$Callback;)V
...
.method public setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/bj;->a(Ljava/lang/CharSequence;)V
