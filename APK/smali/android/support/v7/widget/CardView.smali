...
.field private static final b:Landroid/support/v7/widget/bf;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/CardView;->b:Landroid/support/v7/widget/bf;

    :goto_0
    sget-object v0, Landroid/support/v7/widget/CardView;->b:Landroid/support/v7/widget/bf;

    invoke-interface {v0}, Landroid/support/v7/widget/bf;->a()V
...
.method private a(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-interface/range {v0 .. v6}, Landroid/support/v7/widget/bf;->a(Landroid/support/v7/widget/bc;Landroid/content/Context;IFFF)V
...
.method public getCardElevation()F
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/widget/bf;->e(Landroid/support/v7/widget/bc;)F
...
.method public getMaxCardElevation()F
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/widget/bf;->a(Landroid/support/v7/widget/bc;)F
...
.method public getRadius()F
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/widget/bf;->d(Landroid/support/v7/widget/bc;)F
...
.method protected onMeasure(II)V
    ...
    :sswitch_0
    sget-object v1, Landroid/support/v7/widget/CardView;->b:Landroid/support/v7/widget/bf;

    invoke-interface {v1, p0}, Landroid/support/v7/widget/bf;->b(Landroid/support/v7/widget/bc;)F
    ...
    invoke-interface {v1, p0}, Landroid/support/v7/widget/bf;->c(Landroid/support/v7/widget/bc;)F
...
.method public setCardBackgroundColor(I)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v7/widget/bf;->a(Landroid/support/v7/widget/bc;I)V
...
.method public setCardElevation(F)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v7/widget/bf;->c(Landroid/support/v7/widget/bc;F)V
...
.method public setMaxCardElevation(F)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v7/widget/bf;->b(Landroid/support/v7/widget/bc;F)V
...
.method public setPreventCornerOverlap(Z)V
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/widget/bf;->h(Landroid/support/v7/widget/bc;)V
...
.method public setRadius(F)V
    ...
    invoke-interface {v0, p0, p1}, Landroid/support/v7/widget/bf;->a(Landroid/support/v7/widget/bc;F)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/widget/bf;->g(Landroid/support/v7/widget/bc;)V
